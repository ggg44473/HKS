 ...
 <div class="row">
    ...
    <form method="POST" action="{{route('okrs.update',$objective->id)}}">
        ...
        <div class="form-group col-md-4">
            ...
            <input type="text" class="form-control" name="obj_title" id="objective_title" value="{{$objective->title}}">
        </div>
        <div class="form-group col-md-4">
            <label for="started_at">起始日</label>
            <input type="date" class="form-control" name="st_date" id="started_at" value="{{$objective->started_at}}">
            </div>
        <div class="form-group col-md-4">
            <label for="finished_at">完成日</label>
            <input type="date" class="form-control" name="fin_date" id="finished_at" value="{{$objective->finished_at}}">
        </div>
        @foreach($keyresults as $keyresult)
            ...
            <div class="form-group col-md-2">
                ...
                <input type="number" class="form-control" name="krs_conf{{$keyresult->id}}" id="keyresult_confidence" value="{{$keyresult->confidence}}">
            </div>
            <div class="form-group col-md-2">
                    <label for="keyresult_weight">權重值</label>
                    <input type="number" class="form-control" name="krs_weight{{$keyresult->id}}" id="keyresult_weight" value="{{$keyresult->weight}}">
                </div>
            <div class="form-group col-md-2">
