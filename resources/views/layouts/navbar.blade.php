    ...
    <div class="collapse navbar-collapse" id="navbarSupportedContent">
        ...
        <ul class="navbar-nav ml-auto"> 
            ...
            <li class="nav-item active pl-3">
                <a href="{{ route('user.okr', auth()->user()->id) }}"><img src="{{ auth()->user()->avatar? asset('storage/avatar/'.auth()->user()->id.'/'.auth()->user()->avatar):asset('/img/icon/user/green.svg') }}" class="avatar"></a>
            </li>
