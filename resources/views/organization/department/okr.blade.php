...
<div class="container">
    <div class="row m-3">
        <div class="col-md-2 text-right">
            @if ($department->image)
                <img class="avatar" src="{{ asset($department->image) }}">
            @else
        ...
        <div class="col-md-3 font-weight-light align-self-end"><h4>{{ $department->name }}</h4> </div>
    ...
    <div class="modal {{ count($errors) == 0 ? 'fade' : '' }}" id="objective" tabindex="-1" role="dialog">
        <div class="modal-dialog modal-dialog-centered modal-sm" role="document">
            <div class="modal-content">
                ...
                @include('okrs.create',['type'=>'department']) 
            </div>
        </div>
    </div>
</div>
