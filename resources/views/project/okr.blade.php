...
<div class="container">
    ...
    <ul class="nav nav-tabs justify-content-center" id="myTab" role="tablist">
        ...
        <li class="nav-item">
            <a class="nav-link" id="member-tab" href="{{ route('project.member', $project) }}">成員</a>
        </li>
    </ul>
    <div class="tab-pane fade show pl-sm-4 pr-sm-4">
        ...
        <div class="row m-3 pt-4 justify-content-center">
            ...
            <div class="col-auto mb-2">
                <form action="{{ $project->getOKrRoute() }}" class="form-inline search-form">
    ...
    <div class="modal {{ count($errors) == 0 ? 'fade' : '' }}" id="objective" tabindex="-1" role="dialog">
        <div class="modal-dialog modal-dialog-centered modal-sm" role="document">
            <div class="modal-content">
                ...
                @include('okrs.create', ['route'=>route('project.objective.store', $project->id)])
            </div>
        </div>
    </div>
    @endcan
